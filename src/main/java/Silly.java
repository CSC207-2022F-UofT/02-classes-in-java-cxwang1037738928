...
public class Silly implements Comparable<Silly>{
     ...
     */
    public Silly(String number, String name){this.name = number + name;}

    /**
     *
     * the parameters are number and name
     * This constructor takes in two strings and concatenate them together
     */
